...
//输入错误手机号/邮箱，登录
public class LoginErrorPhoneEmail {
	...
	public void testPhone()throws Exception{
		...
		driver.findElement(By.id("username")).sendKeys("15555555555");
		driver.findElement(By.xpath("//input[@type='password']")).sendKeys("1111111");
	...
	public void testEmail()throws Exception{
		driver.get(baseUrl);
		driver.findElement(By.linkText("登录")).click();
		driver.findElement(By.id("username")).sendKeys("m15548444444@163.com");
		driver.findElement(By.xpath("//input[@type='password']")).sendKeys("1111111");
		driver.findElement(By.xpath("//button[@class='button-long btn btn-default']")).click();
		String errorMessage=driver.findElement(By.xpath("//html/body/div[2]/div/div[2]/div/div/div/div[2]/form/div[1]/label")).getText();
		assertEquals(errorMessage, "您输入的帐号或密码有误,请重新输入");
